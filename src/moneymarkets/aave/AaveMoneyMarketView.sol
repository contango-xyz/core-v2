...
import { GenericLogic } from "@aave/core-v3/contracts/protocol/libraries/logic/GenericLogic.sol";
...
contract AaveMoneyMarketView is IMoneyMarketView {
        ...
        returns (NormalisedBalances memory balances_)
    {
        ...
        balances_.collateral = GenericLogic.getUserBalanceInBaseCurrency(
            _account(positionId), collateralReserveData, _prices.collateral, 10 ** collateralReserveData.configuration.getDecimals()
        );
    ...
    function prices(Symbol, IERC20 collateralAsset, IERC20 debtAsset) public view override returns (Prices memory prices_) {
