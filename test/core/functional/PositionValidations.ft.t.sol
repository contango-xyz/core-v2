...
contract PositionValidationsFunctional is BaseTest {
    ...
    function testValidation01(bool cashflowCcyId) public {
        ...
        require(bytes4(data) == IContango.ExcessiveInputQuote.selector, "error selector not expected");
    ...
    function testValidation05() public {
        ...
        require(!success, "should have failed");
        require(bytes4(data) == IContango.InsufficientBaseCashflow.selector, "error selector not expected");
