...
contract SiloMoneyMarketViewTest is Test {
    ...
    function setUp() public {
        ...
        env.init(162_265_647);

        contango = env.contango();

        sut = env.contangoLens().moneyMarketView(mm);
        rewardsToken = address(env.token(ARB));
    ...
    function testBorrowingLiquidity() public {
        ...
        assertEqDecimal(beforePosition, 1_285_830.53122e6, instrument.quoteDecimals, "Borrowing liquidity");
    ...
    function testLendingLiquidity() public {
        ...
        assertEqDecimal(liquidity, 242_954.76698308932943511e18, instrument.baseDecimals, "Lending liquidity");
    }
    ...
    function testRates() public {
        ...
        assertEqDecimal(borrowingRate, 0.077153300004384e18, 18, "Borrowing rate");
        assertEqDecimal(lendingRate, 0.009117684949929255e18, 18, "Lending rate");
    }
    ...
    function testRewards_NoPosition() public {
        ...
        assertEqDecimal(lending[0].rate, 0.044753954888276062e18, lending[0].token.decimals, "Lend reward[0] rate");
        assertEqDecimal(lending[0].claimable, 0, lending[0].token.decimals, "Lend reward[0] claimable");
        assertEqDecimal(lending[0].usdPrice, 1.090999999999998096e18, 18, "Lend reward[0] usdPrice");
    }
    ...
    function testRewards_ForPosition() public {
        ...
        assertEq(lending[0].token.decimals, 18, "Lend reward[0] decimals");
        assertEq(lending[0].token.unit, 1e18, "Lend reward[0] unit");
        assertEqDecimal(lending[0].rate, 0.097456027243572616e18, lending[0].token.decimals, "Lend reward[0] rate");
        assertEqDecimal(lending[0].claimable, 36.409839147980549994e18, lending[0].token.decimals, "Lend reward[0] claimable");
        assertEqDecimal(lending[0].usdPrice, 1.1e18, 18, "Lend reward[0] usdPrice");
