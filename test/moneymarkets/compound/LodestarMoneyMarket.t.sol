...
contract LodestarMoneyMarketTest is BaseTest {
    ...
    IERC20 internal lode = IERC20(0xF19547f9ED24aA66b03c3a552D181Ae334FBb8DB);
    ...
    function setUp() public {
        ...
        sut = env.deployer().deployLodestarMoneyMarket(env, env.contango());

        positionId = env.encoder().encodePositionId(Symbol.wrap("WETHUSDC"), MM_LODESTAR, PERP, 1);
    ...
    function testInitialise_InvalidExpiry() public {
        ...
        sut = env.deployer().deployLodestarMoneyMarket(env, env.contango());
        positionId = env.encoder().encodePositionId(Symbol.wrap("WETHUSDC"), MM_LODESTAR, PERP - 1, 1);
    ...
    function testInitialise() public {
        ...
        CompoundMoneyMarket emm = env.deployer().deployLodestarMoneyMarket(env, IContango(contango));
    ...
    function testLifeCycle_HP_WETHUSDC() public {
        ...
        assertEqDecimal(lode.balanceOf(address(this)), 19.500854181090979632e18, lode.decimals(), "sonne.balanceOf");
        ...
        vm.prank(contango);
        sut.claimRewards(positionId, lendToken, borrowToken, address(this));
        assertEqDecimal(lode.balanceOf(address(this)), 45.501993088170775787e18, lode.decimals(), "sonne.balanceOf");
    }
